...
/*
02 - Придумайте правильные имена:
Создайте переменную для названия нашей планеты. Как бы вы её назвали?
Создайте переменную для хранения имени текущего посетителя сайта. Как бы вы назвали такую переменную?
*/

let ourPlanet = 'Earth';
let userName = 'Евдоким';


/*
03 - Какие буквы (заглавные или строчные) использовать для имён констант?
важность: 4
...
const BIRTHDAY = '18.04.1982' // Заглавные, так как значение не будет менятся никогда
const age = someCode(BIRTHDAY); // Каждый год значение будет перезаписываться, поэтому с маленькой
